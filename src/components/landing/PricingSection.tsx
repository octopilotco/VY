      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="glass-card rounded-2xl p-8">
            ...
            <Button className="mt-6 w-full rounded-full bg-foreground px-8 py-6 text-base font-semibold text-background hover:bg-foreground/90">
          ...
          {/* ADVANCED */}
          <div className="relative glass-card rounded-2xl border-primary/50 p-8 glow-orange">
            ...
            <p className="mt-1 text-xs text-primary">Early adopter discount</p>
            <Button className="mt-6 w-full rounded-full bg-primary px-8 py-6 text-base font-semibold text-primary-foreground hover:bg-primary/90">
              Get Started for Free
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <ul className="mt-8 space-y-3">
