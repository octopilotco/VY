...
const CreatorsSection = () => {
  return (
    <section id="creators" className="border-b border-border py-24">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {categories.map((cat) => (
            <div key={cat.title} className="glass-card rounded-2xl p-6 transition-colors hover:border-muted-foreground/30">
